...
let handler = async (m, { conn, text, usedPrefix, command, args, participants, isOwner }) => {
 ...
 if (e.length) await conn.reply(res, `🏮 halo cees

@${owbot} dia adalah penciptaku jika kamu ragu
...
*${conn.user.name}* adalah salah satu bot WhatsApp multi device yang dibuat dengan Node.js, *${conn.user.name}* Baru saja diundang oleh *${m.name}*
