...
let handler = async (m, { conn, args, text, usedPrefix, command }) => {
    ...
    let tee = `✳️ Masukkan teks singkat\n\n📌 Contoh : *${usedPrefix + command}* 4K`
    let too = `✳️ Pisahkan teks dengan *+* \n\n📌 Contoh : \de*${usedPrefix + command}* 4K *+* BOTZ`
     m.react(rwait)
 ...
 handler.help = ['logololi', 'neon', 'devil', 'wolf', 'pornhub']
 handler.tags = ['maker']
 handler.command = /^(logololi|neon|devil|wolf|pornhub)$/i
